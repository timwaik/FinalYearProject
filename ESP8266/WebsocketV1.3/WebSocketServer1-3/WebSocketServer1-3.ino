/*This version tests the latency of transmission from one end to the other. This is done by activating one led and transmitting the turn on signal to the other, and noticing the time it takes*/
...
WebSocketsServer webSocket = WebSocketsServer(502);    // create a websocket server on port 81
